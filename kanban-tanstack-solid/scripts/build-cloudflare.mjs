...
await build({
  ...
  build: {
    ...
    rollupOptions: {
      ...
      // Externalize Node.js built-ins, better-sqlite3, and Solid.js (Wrangler will bundle Solid correctly)
      external: (id) => {
        return id.startsWith('node:') ||
               id === 'async_hooks' ||
               id === 'stream' ||
               id === 'better-sqlite3' ||
               id === 'drizzle-orm/better-sqlite3' ||
               id === 'solid-js' ||
               id === 'solid-js/web' ||
               id === 'solid-js/store' ||
...
const wranglerConfig = {
  name: "kanban-tanstack-solid",
  compatibility_date: "2025-01-01",
  compatibility_flags: ["nodejs_compat"],
  d1_databases: [
    {
      binding: "DB",
      database_name: "kanban-db-solid",
...
console.log('\nDeploy with: wrangler pages deploy dist/pages --project-name=kanban-tanstack-solid');
