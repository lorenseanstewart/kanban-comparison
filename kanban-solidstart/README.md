...
A full-featured Kanban board application built with SolidStart, featuring drag-and-drop, real-time updates, and Cloudflare D1 database persistence.
...
- `npm run build` - Build for production (Vinxi build)
...
- `npm run db:push` - Push schema changes to D1 (dev only)
